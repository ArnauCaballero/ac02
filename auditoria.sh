...
numero_usuaris=$(grep -cve "^\s*$" informe_data.txt)
echo "Recompte total d'usuaris a comptabilitat es de $numero_usuaris" > informe_data.txt
cat informe_data.txt
...
numero_usuaris=$(grep -cve "^\s*$" informe_data.txt)
echo "Recompte total d'usuaris a direccio es de $numero_usuaris" > informe_data.txt
cat informe_data.txt
...
numero_usuaris=$(grep -cve "^\s*$" informe_data.txt)
echo "Recompte total d'usuaris a marketing es de $numero_usuaris" > informe_data.txt
cat informe_data.txt
...
numero_usuaris=$(grep -cve "^\s*$" informe_data.txt)
echo "Recompte total d'usuaris a sistemes es de $numero_usuaris" > informe_data.txt
cat informe_data.txt
...
numero_usuaris=$(grep -cve "^\s*$" informe_data.txt)
echo "Recompte total d'usuaris a ventes es de $numero_usuaris" > informe_data.txt
cat informe_data.txt